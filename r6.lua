...
local DEFENDERS = { 
    ...
    "DOC", "ALIBI", "KAPKAN", "THORN", "CASTLE", "VIGIL"
}
...
local OPERATOR_PROFILES = {
    ...
    VIGIL    = { name = "Vigil",    weapon = "SMG-12",    recoilX1 = 4,  recoilY1 = 13, recoilX2 = -1,  recoilY2 = 7  },
    ...
    LESION   = { name = "Lesion",   weapon = "T-5 SMG",   recoilX1 = 1,  recoilY1 = 8,  recoilX2 = -1,  recoilY2 = 7  },
    DOC      = { name = "Doc",      weapon = "MP5",       recoilX1 = -1, recoilY1 = 5,  recoilX2 = 1,   recoilY2 = 5  },
    ...
    CASTLE   = { name = "Castle",   weapon = "UMP",       recoilX1 = 0,  recoilY1 = 4,  recoilX2 = 0,   recoilY2 = 4  },
}
...
local function applyOperator()
    ...
    if profile then
        ...
        OutputLogMessage("[R6S] Warning: No profile found for operator: %s\n", tostring(key))
    end
end
