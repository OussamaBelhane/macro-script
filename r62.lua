...
local OPERATOR_PROFILES = {
    ...
    THERMITE = { name = "Thermite", weapon = "556xi",     recoilX1 =1, recoilY1 = 7, recoilX2 = -1,   recoilY2 = 7 },
    ...
    FENRIR   = { name = "Fenrir",   weapon = "MP7",       recoilX1 = 2,  recoilY1 = 7,  recoilX2 = -1,  recoilY2 = 5 },
    ...
    DOC      = { name = "Doc",      weapon = "MP5",       recoilX1 = -1, recoilY1 = 6,  recoilX2 = 1,   recoilY2 = 5 },
